...
#ifndef JCC_SPANOLD_H
#define JCC_SPANOLD_H
...
public:
	...
	SpanOld(size_t line, size_t lineStartIndex, size_t characterIndex, size_t length, std::istream &inputStream);
	...
	SpanOld operator+(const SpanOld &other) const {
		SpanOld result{};
	...
	const SpanOld &operator+=(const SpanOld &other) {
