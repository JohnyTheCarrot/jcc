...
namespace jcc::preprocessor::commands {
	class IdentifierCommand final : public Command {
		...
		GatherArgumentTokens(Preprocessor &preprocessor, macro::FunctionLikeMacro const &fnMacro);
	...
	public:
		...
		[[nodiscard]]
		std::optional<Tokenizer::Token> Execute(Preprocessor &preprocessor, Tokenizer::Token &&ident) const override;
	};
}// namespace jcc::preprocessor::commands
