...
public:
    ...
    [[nodiscard]]
    const std::string &GetTextVersion() const { return this->_textVersion; };
    ...
    [[nodiscard]]
    size_t GetLineStartIndex() const { return this->_lineStartIndex; }

    [[nodiscard]]
    size_t GetStartCharacterIndex() const { return this->_startCharacterIndex; }

    [[nodiscard]]
    size_t GetColumn() const { return this->_startCharacterIndex - this->_lineStartIndex + 1; }

    [[nodiscard]]
    size_t GetLength() const { return this->_length; }

    [[nodiscard]]
    size_t GetEndCharacterIndex() const { return this->_startCharacterIndex + this->_length; }
